...
本文将不再提供lab的全部代码，只提供关键部分的伪代码，因为raft的整体流程在论文和视频里已经非常清楚了，我做完的lab2也有700多行（[点我看源代码](https://github.com/Bug-terminator/MIT6.824/blob/master/src/raft/raft.go))，就不再结合代码把流程复述一次了。
